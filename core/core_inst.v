	core u0 (
		...
		.io_controleur_std_logic_u_high  (<connected-to-io_controleur_std_logic_u_high>),  // io_controleur.std_logic_u_high
		.io_controleur_std_logic_v_high  (<connected-to-io_controleur_std_logic_v_high>),  //              .std_logic_v_high
		.io_controleur_std_logic_w_high  (<connected-to-io_controleur_std_logic_w_high>),  //              .std_logic_w_high
		.io_controleur_std_logic_u_low   (<connected-to-io_controleur_std_logic_u_low>),   //              .std_logic_u_low
		.io_controleur_std_logic_v_low   (<connected-to-io_controleur_std_logic_v_low>),   //              .std_logic_v_low
		.io_controleur_std_logic_w_low   (<connected-to-io_controleur_std_logic_w_low>),   //              .std_logic_w_low
		.io_controleur_std_logic_secu    (<connected-to-io_controleur_std_logic_secu>),    //              .std_logic_secu
